...
//     var makeParserFromStringStream = function(stringStream) {
// 	var tokenizer = tokenizeScheme(input, _tokenState);
// 	return makeParserFromTokenizer(tokenizer);
//     };


//     var makeParserFromTokenizer = function(tokenizer) {
// 	var Parser = {
// 	    next: function () { 
// 		    ... },
	    
// 	    copy: function () {
// 		var freshTokenizer = tokenizer.clone();
// 		return makeParserFromTokenizer(freshTokenizer);
// 	    };
// 	};
//     };
...
//     return {
// 	make: function(stringStream) { 
// 	    return makeParserFromStringStream(stringStream); 
// 	},
// 	// maybe we should ALWAYS indent on every character?
// 	electricChars: "()[]{}:\n"
//     };
// })();
